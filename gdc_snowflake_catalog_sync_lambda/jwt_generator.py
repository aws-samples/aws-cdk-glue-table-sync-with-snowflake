# This code is taken from Snowflake documentation
# Credit: Snowflake (https://docs.snowflake.com/en/_downloads/aeb84cdfe91dcfbd889465403b875515/sql-api-generate-jwt.py)
...
class JWTGenerator(object):
    ...
    def __init__(
        ...
        :param private_key_file_path: Private key from AWS Secrets
        ...
        # Private key from AWS Secrets
        pemlines = bytes(private_key, "utf-8")
        try:
